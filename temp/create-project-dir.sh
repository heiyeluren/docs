...
create_directory_structure() {
    ...
    mkdir -p "$base_dir/.km"
    mkdir -p "$base_dir/configs/dev"
    mkdir -p "$base_dir/configs/test"
...
EOF
    ...
    # configs 目录的 README
    cat > "$base_dir/configs/README.md" << EOF
# 配置文件目录
...
EOF
    ...
    echo "# 开发环境配置" > "$base_dir/configs/dev/README.md"
    echo "# 测试环境配置" > "$base_dir/configs/test/README.md"
    echo "# 灰度环境配置" > "$base_dir/configs/gray/README.md"
    echo "# 生产环境配置" > "$base_dir/configs/prod/README.md"
